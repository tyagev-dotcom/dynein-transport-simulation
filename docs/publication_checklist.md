...
- Run the simulation on the intended platform and record compiler/version information.
- Check that no local paths, private notes, PDFs, executables, object files, or manuscript drafts are staged in git.
